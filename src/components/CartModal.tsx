...
const CartModal = () => {
  ...
  return (
    <div className="w-max absolute p-4 rounded-md shadow-[0_3px_10px_rgb(0,0,0,0.2)] bg-white top-12 rigt-0 flex flex-col gap-6 z-20">
      {!cartItems ? (
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="">
            ...
            <p className="text-gray-500 text-sm mt-2 mb-4">
              Shipping and taxes calcualted at checkout.
            </p>
            <div className="flex justify-between text-sm">
